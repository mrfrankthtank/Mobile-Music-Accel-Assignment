...
- (IBAction)pitch_stepper:(UIStepper *)sender;
...
- (void)viewDidLoad
{
    ...
    [PdBase sendFloat:60 toReceiver:@"choosepitch"];
}
...
- (IBAction)pitch_stepper:(UIStepper *)sender {
    ...
    [_pitchlabel setText:[NSString stringWithFormat:@"%d", (int)value]];
    [PdBase sendFloat:value toReceiver:@"choosepitch"];}
